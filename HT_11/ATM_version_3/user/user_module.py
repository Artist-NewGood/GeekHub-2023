...
class User:
    ...
    def withdrawal(username: str) -> None:
        ...
        while True:
            money_withdrawal = int(User.check_input_user_data('How much money you want to withdrawal '
    ...
    def replenishment_money(username: str) -> None:
        ...
        while True:
            money_replenishment = float(User.check_input_user_data('How much money you want to replenishment '
                                                                   '(or press "Enter" to cancel)?: '))
            ...
            User.add_transactions(username, int(abs(final_money_replenishment)), amount_balance)
            sleep(1)
            sub_menu(username)
    ...
    @staticmethod
    def show_transactions(username: str, option: object = 1) -> list[Any]:
