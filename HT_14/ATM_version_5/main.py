...
def user_menu(username: str) -> None:
    ...
    from HT_14.ATM_version_5.system.system_module import show_transactions
    ...
    while True:
        print(f'\n____________________\n'
              ...
              f'𝟔. Deposit money\n'
              f'𝟕. Current exchange rate (🔥 NEW Function)\n'
              f'\n'
              f'𝟎. Exit\n'
              f'𝟗. Log out\n'
              f'▼')
        ...
        match input('Your choice: '):
            ...
            case '7':
                sleep(1)
                ATM.get_current_exchange_rate(username)
            case '0':
                print('\n♥ Bye ♥')
                exit()
            case '9':
...
def start() -> None:
    ...
    from HT_14.ATM_version_5.system.system_module import add_new_users, check_login_data
